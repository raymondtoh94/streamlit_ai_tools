...
from src.utils.load import initialize_environment, load_config

# Initialize environment variables
initialize_environment()

# Load config
instructions = load_config("instructions.toml")
...
selected_provider = st.selectbox(
    "Select Provider", options=[key.upper() for key in model_config.keys()]
)
...
sys_instr = st.text_area(
    "System Instructions",
    height=250,
    value=instructions["summarizer"].get("instruction", ""),
)
